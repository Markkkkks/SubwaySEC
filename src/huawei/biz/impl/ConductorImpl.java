...
public class ConductorImpl implements Conductor
{
    ...
    {
        Card card = cardManager.buyCard(enterStation, exitStation);
        return card;
    }
    ...
    public Card buyCard(CardEnum cardEnum, int money)
        throws SubwayException
    {
    	Card card = cardManager.buyCard(cardEnum, money);
        return card;
    }
    ...
    public Card recharge(String cardId, int money)
        throws SubwayException
    {
    	Card card = cardManager.recharge(cardId, money);
        return card;
    }
    ...
    public Card deleteCard(String cardId)
        throws SubwayException
    {
        Card card = cardManager.deleteCard(cardId);
        return card;
    }
}